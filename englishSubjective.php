...
$sql_objective = "SELECT quiz_id, quiz_subject, quiz_question, quiz_option, correct_answer, quiz_level 
                  FROM quiz_question 
                  WHERE quiz_type = 'objective' AND quiz_subject = 'English' AND quiz_level = 'primary'";
...
$sql_subjective = "SELECT quiz_id, quiz_subject, quiz_question, correct_answer 
                  FROM quiz_question 
                  WHERE quiz_type = 'subjective' AND quiz_subject = 'English' AND quiz_level = 'primary'";
...
if (empty($objective_questions) && empty($subjective_questions)) {
