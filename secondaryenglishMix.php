...
$sql = "SELECT quiz_id, quiz_subject, quiz_question, correct_answer 
        FROM quiz_question 
        WHERE quiz_type = 'subjective' AND quiz_subject = 'Math' AND quiz_level = 'primary'";
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo "Correct Answer: " . $row['correct_answer'] . "<br><br>";
    }
} else {
...
if ($result_objective->num_rows > 0) {
    ...
    echo "No objective questions found.";
}

$sql_subjective = "SELECT quiz_id, quiz_subject, quiz_question, correct_answer 
                  FROM quiz_question 
                  WHERE quiz_type = 'subjective' AND quiz_subject = 'English' AND quiz_level = 'secondary'";
...
if ($result_subjective->num_rows > 0) {
    ...
    echo "No subjective questions found.";
}
